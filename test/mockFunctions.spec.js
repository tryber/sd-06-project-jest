...
describe('verifica as funções e os mocks', () => {
  ...
  test('testa função add', () => {
    const esconderAdd = jest.spyOn(mockFunctions, 'add').mockImplementation((a, b) => a + b);
  ...
  test('testa função subtract', () => {
    const esconderSub = jest.spyOn(mockFunctions, 'subtract').mockImplementation((a, b) => a - b);
  ...
  test('testa função multiply', () => {
    const esconderMultiply = jest.spyOn(mockFunctions, 'multiply').mockImplementation((a, b) => a * b);
  ...
  test('testa função divide', () => {
    const escondeDiv = jest.spyOn(mockFunctions, 'divide').mockImplementation((a, b) => a / b);
  ...
  test('testa função power', () => {
    const escondeExp = jest.spyOn(mockFunctions, 'power').mockImplementation((a, b) => a ** b);
  ...
  test('testa função factorial', () => {
    const escondeFactorial = jest.spyOn(mockFunctions, 'factorial').mockImplementation(a => {
      let fact = a;
