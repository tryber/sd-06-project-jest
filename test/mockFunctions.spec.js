...
describe('verifica as funções e os mocks', () => { const mockAdd = jest.spyOn(mockFunctions, 'add').mockImplementation((a, b) => a + b);
...
const mockMultiply = jest.spyOn(mockFunctions, 'multiply').mockImplementation(multiply);
...
test('testa função factorial', () => { expect(mockFunctions.factorial(5)).toEqual(120) 
