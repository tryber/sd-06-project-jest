...
/*
Num universo não tão distante, um grupo de aventureiros da Trybe enfrentam uma série de ites.
...
Cada um dos ites abaixo verifica a quantidade de aventureiros após cada iteração.
Sua missão aqui é:

  - Use a função randomAttack do objeto adventure
  que remove um dos aventureiros toda vez que é chamada,
  ela deve funcionar entre cada ite.
  Opcional:
  - Para ficar mais visível, imprima na tela após cada ite o grupo de aventureiros restante.
  - No fim dos ites, imprima uma mensagem com o nome do aventureiro que sobreviveu.
