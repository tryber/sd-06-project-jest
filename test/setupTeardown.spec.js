...
describe('quem sobreviveu?', () => { beforeEach(() => adventure.randomAttack()) 
test('depois da primeira aventura', () => {
expect(adventure.specialists.length).toBe(5);
})
test('depois da segunda aventura', () => {
expect(adventure.specialists.length).toBe(4);
console.log('testeeeee', adventure.specialists)
})
...
test('depois da quinta aventura', () => {expect(adventure.specialists.length).toBe(1);
})
})